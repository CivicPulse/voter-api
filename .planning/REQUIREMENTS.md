...
- [ ] **SKL-02**: Deterministic Python normalizer post-processes AI-generated markdown to enforce title case, URL normalization, occupation formatting, and field consistency
