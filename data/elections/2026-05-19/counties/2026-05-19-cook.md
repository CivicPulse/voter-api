# Cook County — Local Elections

## Metadata

| Field | Value |
|-------|-------|
| ID | 2307c216-80e4-465c-852d-c66581155176 |
| Format Version | 1 |
...
Voters in Cook County will also see the following statewide and district races on the ballot.
...
| ----------- | -------- | ----------- | ------------ | ----------- |
| Phil Morris Jr | Qualified | Yes | Print Shop Tech | 03/02/2026 |
...
| Candidate | Status | Incumbent | Occupation | Qualified Date |
| ----------- | -------- | ----------- | ------------ | ----------- |
| Guy A. Daughtrey | Qualified | Yes | Retired Accountant/auditor | 03/02/2026 |
...
| Candidate | Status | Incumbent | Occupation | Qualified Date |
| ----------- | -------- | ----------- | ------------ | ----------- |
| Corkey Taylor | Qualified | Yes | Owner Pilot Escort/broker/dispatcher | 03/02/2026 |
...
| Candidate | Status | Incumbent | Occupation | Qualified Date |
| ----------- | -------- | ----------- | ------------ | ----------- |
| Chad Sumner | Qualified | Yes | Farmer | 03/02/2026 |
...
| Candidate | Status | Incumbent | Occupation | Qualified Date |
| ----------- | -------- | ----------- | ------------ | ----------- |
| Stephen M. Chammoun | Qualified | Yes | Chief Magistrate | 03/02/2026 |
