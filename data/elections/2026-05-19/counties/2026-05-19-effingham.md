# Effingham County — Local Elections
...
Voters in Effingham County will also see the following statewide and district races on the ballot.
...
|-----------|--------|-----------|------------|-----------|-------|---------|
| A Michelle Payne | Qualified | No | Attorney | 03/04/2026 | — | — |
| Roger Burdette | Qualified | Yes | Logistics | 03/03/2026 | — | — |
...
| Candidate | Status | Incumbent | Occupation | Qualified | Email | Website |
|-----------|--------|-----------|------------|-----------|-------|---------|
| Jamie Deloach | Qualified | Yes | Commercial Banker | 03/03/2026 | — | — |

**Democrat Primary**

| Candidate | Status | Incumbent | Occupation | Qualified | Email | Website |
|-----------|--------|-----------|------------|-----------|-------|---------|
| Scott Hoffman | Qualified | No | Logistics | 03/04/2026 | — | — |
...
| Candidate | Status | Incumbent | Occupation | Qualified | Email | Website |
|-----------|--------|-----------|------------|-----------|-------|---------|
| N Phillip Kieffer | Qualified | Yes | General Contractor | 03/02/2026 | — | — |

### County Board of Education - District 4

| Candidate | Status | Incumbent | Occupation | Qualified | Email | Website |
|-----------|--------|-----------|------------|-----------|-------|---------|
| Ben Johnson | Qualified | Yes | Real Estate Broker | 03/02/2026 | — | — |

### County Board of Education - District 1

| Candidate | Status | Incumbent | Occupation | Qualified | Email | Website |
|-----------|--------|-----------|------------|-----------|-------|---------|
| Daulton Kerry-Herbert Harris | Qualified | No | Financial Advisor | 03/02/2026 | — | — |
| Lynn Anderson | Qualified | Yes | Manager / Nurse | 03/04/2026 | — | — |
