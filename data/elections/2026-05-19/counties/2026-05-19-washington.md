# Washington County — Local Elections
...
Voters in Washington County will also see the following statewide and district races on the ballot.
...
|-----------|--------|-----------|------------|-----------|-------|---------|
| Amy Joy Wilcher Howard | Qualified | No | Entrepreneur & Real Estate Paralegal | 03/05/2026 | — | — |

**Democrat Primary**

| Candidate | Status | Incumbent | Occupation | Qualified | Email | Website |
|-----------|--------|-----------|------------|-----------|-------|---------|
| Horace Melvin Daniel Jr | Qualified | Yes | Self Employed | 03/05/2026 | meldhvac@yahoo.com | — |
...
| Candidate | Status | Incumbent | Occupation | Qualified | Email | Website |
|-----------|--------|-----------|------------|-----------|-------|---------|
| Harlan Theodore Archer | Qualified | Yes | Retired/ Cattle Farmer | 03/05/2026 | — | — |
...
| Candidate | Status | Incumbent | Occupation | Qualified | Email | Website |
|-----------|--------|-----------|------------|-----------|-------|---------|
| Barbara Jean Davenport | Qualified | No | Retired | 03/02/2026 | — | — |
| Bobby Jackson | Qualified | Yes | Executive Director Non Profit | 03/02/2026 | — | — |
| Richard Douglas Josey Sr | Qualified | No | Retired | 03/02/2026 | — | — |
...
| Candidate | Status | Incumbent | Occupation | Qualified | Email | Website |
|-----------|--------|-----------|------------|-----------|-------|---------|
| Robert Blocker | Qualified | Yes | Business Owner | 03/06/2026 | robertblocker@rocketmail.com | — |
...
| Candidate | Status | Incumbent | Occupation | Qualified | Email | Website |
|-----------|--------|-----------|------------|-----------|-------|---------|
| Alan Eugene Gray | Qualified | Yes | Retired/ Career Center Director | 03/03/2026 | — | — |
| Charnetta Colton-Poole | Qualified | No | Pediatrician | 03/06/2026 | — | — |
...
| Candidate | Status | Incumbent | Occupation | Qualified | Email | Website |
|-----------|--------|-----------|------------|-----------|-------|---------|
| Leigh Jordan | Qualified | Yes | Banker | 03/06/2026 | — | — |
