...
def upgrade() -> None:
    ...
    op.create_index("idx_elections_deleted_at", "elections", ["deleted_at"])
    op.add_column(
        "elections",
...
def downgrade() -> None:
    op.alter_column("elections", "data_source_url", nullable=False)
    ...
    op.drop_index("idx_elections_deleted_at", table_name="elections")
