...
- [ ] T001 Create full project directory structure with all `__init__.py` files per plan.md (src/voter_api/{core,models,schemas,api/v1,services,lib/{geocoder,importer,exporter,analyzer,boundary_loader},cli}/, tests/{unit/{lib/{test_geocoder,test_importer,test_exporter,test_analyzer,test_boundary_loader},test_schemas,test_services,test_core},integration/{test_api,test_database,test_cli},contract/test_openapi,performance/fixtures}/)
