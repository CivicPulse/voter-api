...
- [ ] T048 [US2] Create Alembic migration for geocoded_locations table (with spatial index, voter_id index, partial primary index) and geocoder_cache table per data-model.md in alembic/versions/
