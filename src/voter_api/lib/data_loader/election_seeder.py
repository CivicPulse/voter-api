...
def _extract_election_record(detail: dict) -> dict:
    ...
    return {
        ...
        "district_type": detail.get("district_type"),
        "district_identifier": detail.get("district_identifier"),
        "district_party": detail.get("district_party"),
        "status": detail["status"],
        "source": detail.get("source", "sos_feed"),
        "data_source_url": detail.get("data_source_url"),
