...
class TestAuth:
    ...
    async def test_login_returns_tokens(self, client: httpx.AsyncClient):
    ...
    async def test_login_bad_password_returns_401(self, client: httpx.AsyncClient):
        resp = await client.post(
            _url("/auth/login"),
    ...
    async def test_refresh_token(self, client: httpx.AsyncClient):
    ...
    async def test_get_me(self, admin_client: httpx.AsyncClient):
    ...
    async def test_list_users_admin(self, admin_client: httpx.AsyncClient):
    ...
    async def test_list_users_forbidden_for_viewer(self, viewer_client: httpx.AsyncClient):
...
class TestBoundaries:
    ...
    async def test_list_boundaries(self, client: httpx.AsyncClient):
    ...
    async def test_list_boundaries_filter_by_type(self, client: httpx.AsyncClient):
    ...
    async def test_get_boundary_detail(self, client: httpx.AsyncClient):
    ...
    async def test_get_boundary_not_found(self, client: httpx.AsyncClient):
        fake_id = uuid.uuid4()
        resp = await client.get(_url(f"/boundaries/{fake_id}"))
        assert resp.status_code == 404

    async def test_list_boundary_types(self, client: httpx.AsyncClient):
...
class TestElections:
    ...
    async def test_list_elections(self, client: httpx.AsyncClient):
    ...
    async def test_get_election_detail(self, client: httpx.AsyncClient):
    ...
    async def test_get_election_not_found(self, client: httpx.AsyncClient):
        resp = await client.get(_url(f"/elections/{uuid.uuid4()}"))
        assert resp.status_code == 404

    async def test_create_election_requires_admin(self, viewer_client: httpx.AsyncClient):
        payload = {
...
class TestElectedOfficials:
    ...
    async def test_list_officials(self, client: httpx.AsyncClient):
    ...
    async def test_get_official_detail(self, client: httpx.AsyncClient):
    ...
    async def test_get_official_not_found(self, client: httpx.AsyncClient):
        resp = await client.get(_url(f"/elected-officials/{uuid.uuid4()}"))
        assert resp.status_code == 404

    async def test_list_by_district(self, client: httpx.AsyncClient):
        resp = await client.get(
    ...
    async def test_create_official_requires_admin(self, viewer_client: httpx.AsyncClient):
        payload = {
    ...
    async def test_crud_lifecycle(self, admin_client: httpx.AsyncClient):
    ...
    async def test_get_official_sources(self, client: httpx.AsyncClient):
...
class TestVoters:
    ...
    async def test_search_voters_requires_auth(self, client: httpx.AsyncClient):
        resp = await client.get(_url("/voters"))
        assert resp.status_code == 401

    async def test_search_voters_empty(self, admin_client: httpx.AsyncClient):
    ...
    async def test_voter_not_found(self, admin_client: httpx.AsyncClient):
...
class TestImports:
    ...
    async def test_list_imports_requires_auth(self, client: httpx.AsyncClient):
        resp = await client.get(_url("/imports"))
        assert resp.status_code == 401

    async def test_list_imports_admin(self, admin_client: httpx.AsyncClient):
        resp = await admin_client.get(_url("/imports"))
        assert resp.status_code == 200
        body = resp.json()
        assert "items" in body

    async def test_list_imports_forbidden_for_viewer(self, viewer_client: httpx.AsyncClient):
...
class TestExports:
    ...
    async def test_list_exports_requires_auth(self, client: httpx.AsyncClient):
        resp = await client.get(_url("/exports"))
        assert resp.status_code == 401

    async def test_list_exports(self, admin_client: httpx.AsyncClient):
...
class TestAnalysis:
    ...
    async def test_list_runs_requires_auth(self, client: httpx.AsyncClient):
        resp = await client.get(_url("/analysis/runs"))
        assert resp.status_code == 401

    async def test_list_runs(self, admin_client: httpx.AsyncClient):
        resp = await admin_client.get(_url("/analysis/runs"))
        assert resp.status_code == 200
        body = resp.json()
        assert "items" in body

    async def test_list_runs_forbidden_for_viewer(self, viewer_client: httpx.AsyncClient):
...
class TestDatasets:
    ...
    async def test_list_datasets(self, client: httpx.AsyncClient):
...
class TestPagination:
    ...
    async def test_pagination_params(self, client: httpx.AsyncClient, endpoint: str):
    ...
    async def test_invalid_page_size(self, client: httpx.AsyncClient):
...
class TestRBAC:
    ...
    async def test_admin_can_access_users(self, admin_client: httpx.AsyncClient):
        assert (await admin_client.get(_url("/users"))).status_code == 200

    async def test_analyst_cannot_access_users(self, analyst_client: httpx.AsyncClient):
        assert (await analyst_client.get(_url("/users"))).status_code == 403

    async def test_viewer_cannot_access_users(self, viewer_client: httpx.AsyncClient):
        assert (await viewer_client.get(_url("/users"))).status_code == 403

    async def test_analyst_can_access_analysis(self, analyst_client: httpx.AsyncClient):
        assert (await analyst_client.get(_url("/analysis/runs"))).status_code == 200

    async def test_viewer_cannot_access_analysis(self, viewer_client: httpx.AsyncClient):
